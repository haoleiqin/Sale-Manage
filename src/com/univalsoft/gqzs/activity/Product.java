...
public class Product extends Activity implements OnClickListener, TextWatcher,
	...
	private void initView() {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			  ...
			  aaa = (TextView) arg1.findViewById(R.id.text_name);
	...
	// 选择上下文菜单
		...
		public boolean onContextItemSelected(MenuItem item) {
...

			{
				...
				{
					Intent ins = new Intent(Product.this, Editproduct.class);
...
//					db.delete("sale", "date=?", new String[] { aaa.getText().toString() });
	...
	public void onClick(View v) {
		...
		case R.id.btn_add_customer:
			intent = new Intent(Product.this, add_product_real.class);
			break;
		case R.id.btn_back:
			finish();
			break;
